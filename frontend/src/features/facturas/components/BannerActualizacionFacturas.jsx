...
export default function BannerActualizacionFacturas({ tarea, onCerrar, onCancelar }) {
        ...
        <div style={{
            ...
            {tarea.diff && (
                <div style={{ color: '#9ca3af', fontSize: 11, marginBottom: 6 }}>
                    {fmtN(tarea.diff.nuevas)} facturas nuevas · {fmtN(tarea.diff.actualizadas)} actualizadas
                </div>
            )}
