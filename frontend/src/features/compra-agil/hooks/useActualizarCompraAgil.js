...
import { iniciarActualizacionCompraAgil, getEstadoActualizacionCompraAgil, cancelarActualizacionCompraAgil } from '../api/compraAgilApi';
...
export function useActualizarCompraAgil(onCompletado) {
    ...
    const cancelar = useCallback(async () => {
        ...
        if (!tid) return;
        try {
            await cancelarActualizacionCompraAgil(tid);
        } catch { /* silencioso */ }
        detener();
