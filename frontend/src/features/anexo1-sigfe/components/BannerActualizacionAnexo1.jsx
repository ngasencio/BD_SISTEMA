...
export default function BannerActualizacionAnexo1({ tarea, onCerrar, onCancelar }) {
        ...
        <div style={{
            ...
            {tarea.diff && (
                <div style={{ color: '#9ca3af', fontSize: 11, marginBottom: 6 }}>
                    {fmtN(tarea.diff.archivos_procesados)} tramo(s) sincronizados · {fmtN(tarea.diff.filas_totales)} filas
                </div>
            )}
